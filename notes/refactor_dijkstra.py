...
green_c = Station('green', 'c')
green_e = Station('green', 'e')
green_d = Station('green', 'd')
green_h = Station('green', 'h')
green_j = Station('green', 'j')
green_m = Station('green', 'm')

blue_n = Station('blue', 'n')
blue_e = Station('blue', 'e')
blue_i = Station('blue', 'i')
blue_o = Station('blue', 'o')

brown_a = Station('brown', 'a')
brown_f = Station('brown', 'f')
brown_k = Station('brown', 'k')
brown_j = Station('brown', 'j')
brown_h = Station('brown', 'h')
brown_d = Station('brown', 'd')
brown_e = Station('brown', 'e')


G = {
  red_b:{red_d:5},
  red_d:{red_g:1, green_d:5, brown_d:5},
  red_g:{red_d:1, red_i:1},
  red_i:{red_k:1, blue_i:5}, 
  red_k:{red_i:1, red_l:3, brown_k:5, }, 
  red_l:{red_k:3}, 
  green_c:{green_e:2},
  green_e:{green_c:2, green_d:1, brown_e:5, blue_e:5}, 
  green_d:{green_e:1, red_d:5, brown_d:5, green_h:3}, 
  green_h:{green_d:3, green_j:2, brown_h:5}, 
  green_j:{green_h:2, green_m:5, brown_j:5},
  green_m:{green_j:5}, 
  blue_n:{blue_e:2}, 
  blue_e:{blue_n:2, blue_i:2, green_e:5, brown_e:5},
  blue_i:{blue_e:2, blue_o:5, red_i:5}, 
  blue_o:{blue_i:5}, 
  brown_a:{brown_f:2}, 
  brown_f:{brown_k:3}, 
  brown_k:{brown_j:2, red_k:5}, 
  brown_j:{brown_h:2, green_j:5}, 
  brown_h:{brown_d:3, green_h:5},
  brown_d:{brown_e:1, red_d:5, green_d:5},
  brown_e:{brown_a:2, blue_e:5, green_e:5},
}


shortestPath(G, green_c, red_k)
...
class TransitNetwork(DictMixin):
    def __init__(self, *args, **kwargs):
        self.station_dict = {}
    def __getitem__(self, key):
        return self.station_dict[key]
    def __setitem__(self, key, item):
        self.station_dict[key] = item
    def __delitem__(self, key):
    ...
    def add_station(self, line, name, links):
        ...
        self.station_dict[station.get_unique_name()] = station
...
class TransitNetwork(DictMixin):
    ...
    def add_station(self, line, name, links):
        station = Station(line, name, links)
        self.station_dict[station] = station
