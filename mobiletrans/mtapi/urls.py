...
urlpatterns_2 = [
    ...
    url(r'^border_routes/(?P<name>\w+)$',
        views.RailLinesRouteBorderView.as_view(),
        {}, name="api2_border_routes"),

    url(r'^neighborhood_from/latlong$',
        views.NeighborhoodFromCoordView.as_view(),
        {}, name="api2_neighborhood_from"),
]
