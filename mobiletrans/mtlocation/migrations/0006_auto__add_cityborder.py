...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mtlocation_cityborder', (
        ...
        db.send_create_signal(u'mtlocation', ['CityBorder'])


    def backwards(self, orm):
        
        # Deleting model 'CityBorder'
        db.delete_table(u'mtlocation_cityborder')
    ...
    models = {
        ...
        u'mtlocation.cityborder': {
            'Meta': {'object_name': 'CityBorder'},
