...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CTARailLines'
        db.create_table(u'mtlocation_ctaraillines', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objectid', self.gf('django.db.models.fields.IntegerField')()),
            ('segment_id', self.gf('django.db.models.fields.IntegerField')()),
            ('asset_id', self.gf('django.db.models.fields.IntegerField')()),
            ('transit_lines', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
            ('legend', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('alt_legend', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('branch', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('shape_len', self.gf('django.db.models.fields.FloatField')()),
            ('line', self.gf('django.contrib.gis.db.models.fields.LineStringField')(srid=-1)),
        ))
        db.send_create_signal(u'mtlocation', ['CTARailLines'])


    def backwards(self, orm):
        
        # Deleting model 'CTARailLines'
        db.delete_table(u'mtlocation_ctaraillines')
    ...
    models = {
        ...
        u'mtlocation.ctaraillines': {
            ...
            'line': ('django.contrib.gis.db.models.fields.LineStringField', [], {'srid': '-1'}),
